...
document.querySelector('.i-1').onkeypress = () => {
    console.log(event)
...
document.querySelector('.i-2').onkeypress = () => {
...
document.querySelector('.i-3').onkeypress = () => {
...
function t7() {
    ...
    a7.push(event.key)
    document.querySelector(".out-7").innerHTML = a7[Math.floor(Math.random(a7.length - 1) * a7.length)]
...
document.querySelector('.i-8').onkeypress = () => {
    let newKey;
    switch (event.key){
        case "i":
            newKey = 1;
    ...
    document.querySelector('.out-8').innerHTML = newKey
}
// ваше событие здесь!!!
