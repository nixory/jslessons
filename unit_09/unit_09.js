...
function f5() {
    let d = document.querySelector('.out-4')
    let b = d.classList;
    let c = b.length;
...
function f6() {
 let d = document.querySelectorAll('.p-6').length
    document.querySelector('.out-6').innerHTML = d;
}
...
function f7() {
    let d = document.querySelectorAll('.out-7');
    for ( let i = 0; i < d.length; i++) {
        d[i].classList.add('bg-7')
    }
}
...
function f8() {
    let d = document.querySelectorAll('.out-8');
    for ( let i = 0; i < d.length; i++) {
        d[i].classList.toggle('bg-8')
    }
}
...
function f12() {
    let div =  document.createElement("div")
    div.textContent = "12" ; div.classList.add('bg-12');
...
function f13() {
    let div =  document.createElement("div")
    div.textContent = "pushMe" ; div.classList.add('bg-13');
    div.onclick = f13_1;
...
function f14() {
    let div =  document.createElement("div")
    div.textContent = "12" ; div.classList.add('bg-14');
...
function f15() {
    let div =  document.createElement("div")
    div.textContent = "12" ; div.classList.add('bg-15');
...
function f16() {
    let div =  document.createElement("div")
    div.textContent = "12" ; div.classList.add('bg-16');
...
function f18() {
    let f = document.querySelector('.p-18').getAttribute('data-b');
...
function f19() {
    let f = document.querySelectorAll('.p-19');
    for ( let i = 0; i < f.length; i++) {
        console.log(f[i].getAttribute('data-b'))

        document.querySelector('.out-19').append( f[i].getAttribute('data-b') + " ")
    }
}
