...
function f6() {
    let check = document.querySelector('.i-6').value;
    document.querySelector('.out-6').innerHTML = check;
}
...
function f7() {
    let passw = document.querySelector('.i-7').value.length;
    if ( passw >= 6) {
...
function f8() {
    document.querySelector('.out-8').innerHTML = '<input class="i-81" value="Zopa"> <button class="b-81"></button>'
...
function f9() {
    ...
    if (radio.checked) {
        document.querySelector('.out-9').innerHTML = radio.value;
    }
    else {
