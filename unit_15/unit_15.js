...
const f3 = () => {
    let b = document.querySelector('.i-3').value;
...
const f4 = () => {
    let b = document.querySelector('.i-4').value;


    document.querySelector('.out-4').innerHTML = s4.has(b);
...
const f6 = () => {
    let s6_uniq = new Set(a6);
    document.querySelector('.out-6').innerHTML = s6_uniq.size;
}
...
const f7 = () => {
    ...
    value.split();
    if (value.length > 6 ) {
        let value_uniq = new Set(value);
        if (value.length == value_uniq.size) {
            document.querySelector('.out-7').innerHTML = 1;
        }
        else {
            document.querySelector('.out-7').innerHTML = "Ne uniq";
        }
    }
    else {
        document.querySelector('.out-7').innerHTML = "Malo";
    }
}
...
const f10 = (out_set, elem) => {
    ...
    document.querySelector(elem).innerHTML = outt;
}
