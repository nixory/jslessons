...
function f2(){
    let b =  a21 > a22 ? document.querySelector('.out-2').innerHTML = a21 :
...
function f3(){
    let firstInput = +document.querySelector('.i-31').value;
    let secondInput = +document.querySelector('.i-32').value;
    if (firstInput > secondInput ) {
        document.querySelector('.out-3').innerHTML = firstInput;
    }
    else {
        document.querySelector('.out-3').innerHTML = secondInput;
    }
}
...
function f4(){
    let value = document.querySelector('.i-4');
    let s = value.value;
    if ( s >= 18) {
...
function f6(){
    let value = +document.querySelector('.i-6').value % 2;
    if ( value == 0 ) {
        document.querySelector('.out-6').innerHTML = "четное";
    }
    else {
        document.querySelector('.out-6').innerHTML = "нечетное";
    }
}
...
function f7(){
    let value = +document.querySelector('.i-71').value;
    let valuesec = +document.querySelector('.i-72').value;
    document.querySelector('.out-7').innerHTML = Math.pow(value, valuesec);
}
