...
function f11() {
    let val = parseInp('.i-11');
    val = parseInt(val);

    document.querySelector('.out-11').innerHTML = d11.indexOf(val);
}
...
function f17() {
    for (let a = 0; a < d171.length; a++) {
        d17.push(d171[a])
    }
    for (let a = 0; a < d172.length; a++) {
        d17.push(d172[a])
    }
    showArr('.out-17', d17);
}
